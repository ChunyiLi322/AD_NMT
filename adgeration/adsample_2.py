...
string_file_begin = "/home/lcy/adsample/seqtoseq_nmt-masterOKpy36/seqtoseq_nmt-master/assets/fra-eng/01/" # need change
...
def adsample_generation(number_input):    
    ...
    nlp=StanfordCoreNLP(r'/home/lcy/adsample/NCR2Code/') # need change
